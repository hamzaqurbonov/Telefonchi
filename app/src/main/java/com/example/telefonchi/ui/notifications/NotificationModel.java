...
//    }
    ...
    public NotificationModel(String name, String nick, String comment, String year, Integer totalSum, Integer startSum, Integer finishSum, Integer amountMonth, Integer sumMonth, Integer tel, Integer payment) {
        this.name = name;
        this.nick = nick;
